...
nvfortran -acc -Minfo=accel -cpp -module .Modules/ Vector_Mod.o Full_Matrix_Mod.o Compute_Mod.o Main.o -o With_Gpu
...
nvfortran                   -cpp -module .Modules/ Vector_Mod.o Full_Matrix_Mod.o Compute_Mod.o Main.o -o No_Gpu
